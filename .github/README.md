...
- Get your [Necessary Variables](https://github.com/wanglin-music/CaiLinXMusic/blob/master/sample.env)
---
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/wanglin-music/CaiLinXMusic && cd CaiLinXMusic
   ```
