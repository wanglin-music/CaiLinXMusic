...
async def check_auth_token():
    video_url = "https://www.youtube.com/watch?v=rQiVZao1dE4"
...
async def cookies_status(client, message):
    ...
    cookie_status = await check_cookies("https://www.youtube.com/watch?v=rQiVZao1dE4")
    status_message = "**Cookie Status:**\n"
...
async def auth_token_status(client, message):
    ...
    if not use_token:
        ...
        try:
            os.system(
                f"yt-dlp --username oauth2 --password '' -F https://www.youtube.com/watch?v=rQiVZao1dE4"
            )
