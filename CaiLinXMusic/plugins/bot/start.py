...
from CaiLinXMusic.misc import _boot_
from CaiLinXMusic.plugins.sudo.sudoers import sudoers_list
from CaiLinXMusic.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_lang,
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            return await message.reply_video(
                video="https://files.catbox.moe/ms6cru.mp4",
